...
class DriverOnlineService {
  ...
  Future<void> _startBackgroundTracking() async {
    ...
    // Service is alive but its location stream may have died (for example a
    // permission error). startTracking() is a no-op if it is already running.
    developer.log(
      'BACKGROUND: Service running, requesting tracking retry',
      name: 'DriverOnlineService',
    );
    _backgroundService.invoke('start_tracking');
  }
